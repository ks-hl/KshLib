...
public class MapRenderer extends org.bukkit.map.MapRenderer {
    ...
    public MapRenderer(String title, Color bgColor, int values, int majorMinecraftVersion) {
        this.title = title;
        this.bgColor = bgColor;
        this.values = new double[values];
        this.majorMinecraftVersion = majorMinecraftVersion;
        this.xDivs = 11;
    }
