...
public class TestComponentHelper {
    ...
    public void testComponentHelper() {
        ...
        assertEquals(full, ComponentHelper.stripMiniMessage(full, false, false, false, false, false, false, false));
        assertEquals(FORMAT + OBFUSCATE, ComponentHelper.stripMiniMessage(full, false, true, false, false, false, false, false));
